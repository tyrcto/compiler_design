...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PAR_L = 8,                      /* PAR_L  */
  YYSYMBOL_PAR_R = 9,                      /* PAR_R  */
  YYSYMBOL_SBRA_L = 10,                    /* SBRA_L  */
  YYSYMBOL_SBRA_R = 11,                    /* SBRA_R  */
  YYSYMBOL_BRA_L = 12,                     /* BRA_L  */
  YYSYMBOL_BRA_R = 13,                     /* BRA_R  */
  YYSYMBOL_ADD = 14,                       /* ADD  */
  YYSYMBOL_SUB = 15,                       /* SUB  */
  ...
  YYSYMBOL_FLOAT_VAL = 57,                 /* FLOAT_VAL  */
  YYSYMBOL_STRING_VAL = 58,                /* STRING_VAL  */
  YYSYMBOL_ID = 59,                        /* ID  */
  YYSYMBOL_CUT = 60,                       /* CUT  */
  YYSYMBOL_UMINUS = 61,                    /* UMINUS  */
  YYSYMBOL_YYACCEPT = 62,                  /* $accept  */
  YYSYMBOL_program = 63,                   /* program  */
  YYSYMBOL_class_block = 64,               /* class_block  */
  YYSYMBOL_data_type = 65,                 /* data_type  */
  YYSYMBOL_func_decs = 66,                 /* func_decs  */
  YYSYMBOL_func_dec = 67,                  /* func_dec  */
  YYSYMBOL_formal_arguments = 68,          /* formal_arguments  */
  YYSYMBOL_formal_argument = 69,           /* formal_argument  */
  YYSYMBOL_const_or_var_dec = 70,          /* const_or_var_dec  */
  YYSYMBOL_const_decs = 71,                /* const_decs  */
  YYSYMBOL_const_dec = 72,                 /* const_dec  */
  YYSYMBOL_var_decs = 73,                  /* var_decs  */
  YYSYMBOL_var_dec = 74,                   /* var_dec  */
  YYSYMBOL_statements = 75,                /* statements  */
  YYSYMBOL_statement = 76,                 /* statement  */
  YYSYMBOL_simple_stmt = 77,               /* simple_stmt  */
  YYSYMBOL_block_stmt = 78,                /* block_stmt  */
  YYSYMBOL_block_body = 79,                /* block_body  */
  YYSYMBOL_conditional_stmt = 80,          /* conditional_stmt  */
  YYSYMBOL_block_or_simple = 81,           /* block_or_simple  */
  YYSYMBOL_loop_stmt = 82,                 /* loop_stmt  */
  YYSYMBOL_constant_exp = 83,              /* constant_exp  */
  YYSYMBOL_integer_expr = 84,              /* integer_expr  */
  YYSYMBOL_boolean_expr = 85,              /* boolean_expr  */
...
static const yytype_int16 yyrline[] =
{
      ...
      85,    86,    87,    88,    89,    90,    92,    93,    94,    98,
      99,   100,   101,   102,   103,   104,   105,   106,   108,   109,
     110,   111,   112,   113,   123,   124,   127,   128,   129,   130,
     131,   135,   136,   137,   138,   139,   140,   141,   147,   148,
     149,   150,   152,   157,   160,   161,   163,   166,   171,   175,
     175,   176,   177,   182,   184,   187,   188,   195,   196,   207,
     218,   229,   240,   251,   262,   273,   284,   295,   306,   307,
     308
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DOT", "COMMA",
  "COLON", "SEMICOLON", "ARROW", "PAR_L", "PAR_R", "SBRA_L", "SBRA_R",
  "BRA_L", "BRA_R", "ADD", "SUB", "MULT", "DIVIDE", "PERCENT", "LE",
  "LEEQ", "GR", "GREQ", "EQ", "NEQ", "AND", "OR", "NOT", "ASSIGN",
  "BOOLEAN", "BREAK", "CHAR", "CASE", "CLASS", "CONTINUE", "DECLARE", "DO",
  "ELSE", "EXIT", "FLOAT", "FOR", "FUN", "IF", "INT", "LOOP", "PRINT",
  "PRINTLN", "RETURN", "STRING", "VAL", "VAR", "WHILE", "IN", "ss",
  "FALSE", "TRUE", "INT_VAL", "FLOAT_VAL", "STRING_VAL", "ID", "CUT",
  "UMINUS", "$accept", "program", "class_block", "data_type", "func_decs",
  "func_dec", "formal_arguments", "formal_argument", "const_or_var_dec",
  "const_decs", "const_dec", "var_decs", "var_dec", "statements",
  "statement", "simple_stmt", "block_stmt", "block_body",
  "conditional_stmt", "block_or_simple", "loop_stmt", "constant_exp",
  "integer_expr", "boolean_expr", "expr", YY_NULLPTR
};
...
#line 1293 "myyacc.tab.c"
    break;

  case 7: /* data_type: FLOAT  */
#line 78 "myyacc.y"
                                { (yyval.intVal) = TYPE_FLOAT;}
#line 1299 "myyacc.tab.c"
    break;

  case 8: /* data_type: STRING  */
#line 79 "myyacc.y"
                                { (yyval.intVal) = TYPE_STRING;}
#line 1305 "myyacc.tab.c"
    break;

  case 9: /* data_type: BOOLEAN  */
#line 80 "myyacc.y"
                                { (yyval.intVal) = TYPE_BOOL;}
#line 1311 "myyacc.tab.c"
    break;

  case 48: /* block_stmt: BRA_L block_body BRA_R  */
#line 147 "myyacc.y"
                                    { (yyval.intVal) = (yyvsp[-1].intVal); }
#line 1317 "myyacc.tab.c"
    break;

  case 58: /* constant_exp: INT_VAL  */
#line 171 "myyacc.y"
                      { 
         (yyval.intVal) = TYPE_INT;
         int_value = (yyvsp[0].intVal);
       }
#line 1326 "myyacc.tab.c"
    break;

  case 65: /* expr: PAR_L expr PAR_R  */
#line 187 "myyacc.y"
                        { (yyval.intVal) = (yyvsp[-1].intVal); }
#line 1332 "myyacc.tab.c"
    break;

  case 66: /* expr: SUB expr  */
#line 189 "myyacc.y"
          { 
...
#line 1373 "myyacc.tab.c"
    break;

  case 70: /* expr: expr PERCENT expr  */
#line 219 "myyacc.y"
          { 
		 if((yyvsp[-2].intVal) == (yyvsp[0].intVal)){
			 if((yyvsp[-2].intVal) == TYPE_INT || (yyvsp[-2].intVal) == TYPE_FLOAT){
...
#line 1418 "myyacc.tab.c"
    break;

  case 73: /* expr: expr LEEQ expr  */
#line 252 "myyacc.y"
         { 
		 if((yyvsp[-2].intVal) == (yyvsp[0].intVal)){
			 if((yyvsp[-2].intVal) == TYPE_INT || (yyvsp[-2].intVal) == TYPE_FLOAT){
...
#line 1433 "myyacc.tab.c"
    break;

  case 74: /* expr: expr GR expr  */
#line 263 "myyacc.y"
         { 
		 if((yyvsp[-2].intVal) == (yyvsp[0].intVal)){
			 if((yyvsp[-2].intVal) == TYPE_INT || (yyvsp[-2].intVal) == TYPE_FLOAT){
...
#line 1448 "myyacc.tab.c"
    break;

  case 75: /* expr: expr GREQ expr  */
#line 274 "myyacc.y"
         { 
		 if((yyvsp[-2].intVal) == (yyvsp[0].intVal)){
			 if((yyvsp[-2].intVal) == TYPE_INT || (yyvsp[-2].intVal) == TYPE_FLOAT){
...
#line 1493 "myyacc.tab.c"
    break;


#line 1497 "myyacc.tab.c"
